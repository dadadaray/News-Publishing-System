                                        ...
                                        <form class="am-form tpl-form-line-form">
                                            ...
                                            <div style="overflow: hidden;margin-top: 20px;" >   
                                                <div class="am-u-md-3" style="float: left;">
                                                    <!--  图片上传显示-->
                                                    <!--input-group start-->
                                                    <div class="upload_box"><input type="file" name="file"  class="file" onchange="imgChange(this);" style="width: 170px;outline:none;"  /><div class="preview"><img class="imghead" src="assets/img/photo_icon.png" width="194" height="111"/></div></div>
                                                    <!--input-group end-->
                                                </div>
                                                <!--文本域 --> 
                                                <div class="am-u-md-9" style="float: left;">
                                                    <textarea rows="8" id="doc-ta-1" style="width:100%;font-size:16px; line-height: 28px;border:1px solid #c2cad8;" maxlength="200" placeholder="请输入不超过200字内容"></textarea> 
                                                </div>
                                            </div>
                                            <div style="overflow: hidden;margin-top: 20px;" >   
                                                <!--  图片上传显示-->
                                            ...
                                            <div class="am-form-group">
                                                ...
                                                <div class="am-u-sm-10">
                                                    <!--  图片上传显示-->
                                                    <!--input-group start-->
                                                    <div class="upload_box"><input type="file" name="file"  class="file" onchange="imgChange(this);" style="width:260px;outline: none;" /><div class="preview" style="margin-top: 20px;"><img class="imghead" src="assets/img/add.png" width="320" height="136"/></div></div>
                                                    <!--input-group end-->
                                                </div>
                                            </div> 
                                            <div class="am-u-sm-8 am-u-sm-push-2 add_button">
                                                <a class="am-btn am-btn-primary tpl-btn-bg-color-success add_draft">存草稿</a>
                                                <a href="../前台/news_post_style2_eye.html" class="am-btn am-btn-primary tpl-btn-bg-color-success add_eye">预  览</a>
