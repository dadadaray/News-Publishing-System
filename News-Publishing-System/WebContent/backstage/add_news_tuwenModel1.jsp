                                        ...
                                        <form class="am-form tpl-form-line-form">
                                            ...
                                            <div style="overflow: hidden;margin-top: 20px;" >   
                                                <div class="am-u-md-3" style="float: left;">
                                                    <!--  图片上传显示-->
                                                    <!--input-group start-->
                                                    <div class="upload_box"><input type="file" name="file"  class="file" onchange="imgChange(this);" style="width: 170px;outline:none;"  /><div class="preview"><img class="imghead" src="${ctx}/assets/img/photo_icon.png" width="194" height="111"/></div></div>
                                                    <!--input-group end-->
                                                </div>
                                                <!--文本域 --> 
                                            ...
                                            <div class="am-form-group">
                                                ...
                                                <div class="am-u-sm-10">
                                                    <!--  图片上传显示-->
                                                    <!--input-group start-->
                                                    <div class="upload_box"><input type="file" name="file"  class="file" onchange="imgChange(this);" style="width:260px;outline: none;" /><div class="preview" style="margin-top: 20px;"><img class="imghead" src="${ctx}/assets/img/add.png" width="320" height="136"/></div></div>
                                                    <!--input-group end-->
                                                </div>
                                            </div> 
