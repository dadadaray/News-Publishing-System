				...
				<div class="am-u-md-12 am-u-sm-14 row-mb">
					<div class="tpl-portlet" style="margin-bottom: 10px; overflow: hidden;">
						...
						<div class="am-btn-group" style="float: left;">
							...
							<a href="${ctx}/add_news_vedio.jsp" class="am-btn am-btn-primary am-radius" style="margin-left: 10px;">视频专题</a>
					...
					<div class="tpl-portlet">
						<div class="portlet-title">
							<div class="caption font-green bold">
								<span class="am-icon-pencil">&nbsp&nbsp编辑视频</span>
							</div>
							<div class="tpl-block">
								<div class="am-g">
									<div class="tpl-form-body tpl-form-line">
										<form class="am-form tpl-form-line-form">
											...
											<div class="am-u-sm-8 am-u-sm-push-2 add_button">
												...
												<a href="../前台/news_post_video_eye.jsp" class="am-btn am-btn-primary tpl-btn-bg-color-success add_eye">预 览</a>
