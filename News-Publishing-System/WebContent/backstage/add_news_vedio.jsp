...
<body data-type="index">
			...
			<ul
				...
				<li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
					...
					href="javascript:;"> <span class="am-icon-bell-o"></span> 提醒 <span
						class="am-badge tpl-badge-success am-round">3</span>
				</a>
					<ul class="am-dropdown-content tpl-dropdown-content">
						...
						<li class="tpl-dropdown-list-bdbc" onclick="sendsuc(this)"><a
							href="#" class="tpl-dropdown-list-fl"> <span
								class="am-icon-btn am-icon-bell-o tpl-dropdown-ico-btn-size tpl-badge-success"></span>
								<span>《从大城市的》</span>需要修改
						</a> <span class="tpl-dropdown-list-fr">3小时前</span></li>
						<li class="tpl-dropdown-list-bdbc" onclick="sendsuc(this)"><a
							href="#" class="tpl-dropdown-list-fl"> <span
								class="am-icon-btn am-icon-bell-o tpl-dropdown-ico-btn-size tpl-badge-danger"></span>
								<span>《从大城市的》</span>审核通过
						</a> <span class="tpl-dropdown-list-fr">15分钟前</span></li>
						<li class="tpl-dropdown-list-bdbc" onclick="sendsuc(this)"><a
							href="#" class="tpl-dropdown-list-fl"> <span
								class="am-icon-btn am-icon-bell-o tpl-dropdown-ico-btn-size tpl-badge-warning"></span>
								<span>《从大城市的》</span>成为推荐文章
						</a> <span class="tpl-dropdown-list-fr">2天前</span></li>
					</ul>
				</li>
				...
				<li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
					<a href="userinfo.jsp"> <span class="tpl-header-list-user-nick">${bloginUser.loginName}</span><span
						class="tpl-header-list-user-ico"> <img
							src="${ctx1}/imgUp/${bloginUser.userInfo.headUrl}"></span>
				</a>
				</li>
	...
	<div class="tpl-page-container tpl-page-header-fixed">
			...
			<div class="tpl-left-nav-list">
				<ul class="tpl-left-nav-menu">
					<li class="tpl-left-nav-item"><a
						href="${ctx1}/backstage/indexs" class="nav-link"> <i
							class="am-icon-home"></i> <span>首页</span>
					</a></li>
					<li class="tpl-left-nav-item"><a href="${ctx}/add_news.jsp"
						class="nav-link  tpl-left-nav-link-list active"> <i
							class="am-icon-edit"></i> <span>添加新文章</span>
					</a></li>
					<li class="tpl-left-nav-item"><a
						href="${ctx1}/backstage/notice"
						class="nav-link  tpl-left-nav-link-list"> <i
							class="am-icon-bell-o"></i> <span>通知管理</span>
					</a></li>
					<li class="tpl-left-nav-item"><a
						href="${ctx1}/backstage/draft/list"
						class="nav-link  tpl-left-nav-link-list"> <i
							class="am-icon-inbox"></i> <span>草稿箱</span>
					</a></li>
					<li class="tpl-left-nav-item"><a href="${ctx}/all_news.jsp"
						class="nav-link  tpl-left-nav-link-list"> <i
							class="am-icon-wpforms"></i> <span>文章管理</span>
					</a></li>
					<li class="tpl-left-nav-item"><a href="javascript:;"
						class="nav-link tpl-left-nav-link-list"> <i
							class="am-icon-user"></i> <span>个人中心</span> <i
							class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right"></i>
					</a>
						<ul class="tpl-left-nav-sub-menu">
							<li><a href="${ctx}/userinfo.jsp"> <i
									class="am-icon-angle-right"></i> <span>个人资料</span>
							</a> <a href="${ctx}/re_userinfo.jsp"> <i
									class="am-icon-angle-right"></i> <span>完善信息</span>
							</a> <a href="${ctx1}/backstage/logOut"> <i
									class="am-icon-angle-right"></i> <span>退出登录</span>
							</a></li>
						</ul></li>
				</ul>
			</div>
				...
				<div class="am-u-md-12 am-u-sm-14 row-mb">
					<div class="tpl-portlet"
						...
						<div class="am-btn-group" style="float: left;">
							<a href="${ctx}/add_news.jsp"
								class="am-btn am-btn-secondary am-radius"
								style="margin-left: 20px;">图文自由排版</a> <a
								href="${ctx}/add_news_img.jsp"
								class="am-btn am-btn-secondary am-radius"
								style="margin-left: 10px;">大图轮播</a> <a
								href="${ctx}/add_news_vedio.jsp"
								class="am-btn am-btn-primary am-radius"
								style="margin-left: 10px;">视频专题</a> <a
								href="${ctx}/add_news_audio.jsp"
								class="am-btn am-btn-secondary am-radius"
								style="margin-left: 10px;">音频专题</a> <a
								href="${ctx}/add_news_tuwenModel.jsp"
								class="am-btn am-btn-secondary am-radius"
								style="margin-left: 10px;">图文模板</a>
						</div>
					</div>
					...
					<div class="tpl-portlet">
						<div class="portlet-title">
							<div class="caption font-green bold">
								<span class="am-icon-pencil">&nbsp;&nbsp;编辑视频</span>
							</div>
							<div class="tpl-block">
								<div class="am-g">
									<div class="tpl-form-body tpl-form-line">
										<form id="videoForm" class="am-form tpl-form-line-form"
											...
											<div class="am-form-group am-form-file"
												...
												<input id="doc-form-file" type="file" name="videoFile"
													class="file" multiple>
											...
											<div class="am-form-group">
												...
												<div class="am-u-sm-10">
													<input type="text" class="tpl-form-input" name="title"
														id="user-name" placeholder="请输入标题文字"> <small
														style="color: red;">请填写标题文字10-20字左右。</small>
												</div>
											</div>
											<div class="am-form-group">
											...
											<div class="am-form-group">
												<div class="am-u-sm-12">
													<textarea name="textarea" class="" rows="10"
														id="user-intro" placeholder="请输入视频介绍" type="hidden"></textarea>
												</div>
											</div>
											...
											<div class="am-form-group">
												...
												<div class="am-u-sm-10">
													...
													<!--input-group start-->
													<div class="upload_box">
														<input type="file" name="coverfile" class="file"
															onchange="imgChange(this);" style="width: 260px" />
														<div class="preview" style="margin-top: 20px;">
															<img class="imghead" src="${ctx}/assets/img/add.png"
											...
											<div class="am-u-sm-8 am-u-sm-push-2 add_button">
												...
												<a id="preview" class="am-btn am-btn-primary tpl-btn-bg-color-success add_eye">预览</a> 
												<a id="videoSends" class="am-btn am-btn-primary tpl-btn-bg-color-success add_fa">发布</a>
											</div>
										</form>
									</div>
								</div>
		...
		<script language="javascript" type="text/javascript"
			src="assets/js/tinymce/tinymce.js"></script>

		<script type="text/javascript">
			//发布按钮
			$("#videoSends").click(function() {
				var url = "${ctx1 }/addnews/video/sendVideoNews";
				$("#videoForm").attr("action", url);
				$("#videoForm").submit();
			});

			//存草稿按钮
			$("#saveNewsDraft").click(function() {
				var url = "${ctx1 }/addnews/video/videoSaveNewsDraft";
				$("#videoForm").attr("action", url);
				$("#videoForm").submit();
			});
			//预览按钮
			$("#preview").click(function() {
				var url = "${ctx1}/addnews/video/previewVideo";
				$("#videoForm").attr("action", url);
				$("#videoForm").attr("target", "_blank");
				$("#videoForm").submit();
