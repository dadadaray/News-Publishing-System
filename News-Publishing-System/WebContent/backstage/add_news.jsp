...
<body data-type="index">
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            <div class="row">
                <div class="am-u-md-10 am-u-sm-12 row-mb">
                    <div class="tpl-portlet" style="margin-bottom:10px;overflow:hidden;">
                        ...
                        <div class="am-btn-group" style="float:left;">
                            <a href="add_news.html" class="am-btn am-btn-primary am-radius" style="margin-left:20px;">图文自由排版</a>
                                    ...
                                    <div class="tpl-form-body tpl-form-line">
                                        <form class="am-form tpl-form-line-form">
                                            ...
                                            <div class="am-u-sm-8 am-u-sm-push-2 add_button">
                                                ...
                                                <a href="../前台/news_post_eye.html" class="am-btn am-btn-primary tpl-btn-bg-color-success add_eye">预  览</a>
