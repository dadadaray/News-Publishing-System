											...
											<article class="block_single_news">
												...
												<div class="info row">
													<div class="am-u-md-4 am-u-sm-4 date">
														<p><fmt:formatDate value="${OneNews.createTime}" pattern="yyyy-MM-dd" /></p>
													</div>
												...
												<div class="content">
												<c:if test="${not empty OneNews.modMixLRs}">
                               						<c:forEach items="${OneNews.modMixLRs}" var="modMixLR">	
													<div class="separator" style="height: 4px;"></div>
													<p>
														<a href="#" class="pic_con_style_tu21"> 
															<img src="${ctx1}/newsImgUp/${modMixLR.mMixLRImgOne}" align="right" width="310px" height="130.px"/>
														</a>
														${modMixLR.mMixLRContentOne}
													</p>
													<p>
														<a href="#" class="pic_con_style_tu22"> 
															<img src="${ctx1}/newsImgUp/${modMixLR.mMixLRImgTwo}" align="right" width="310px" height="130.px"/>
														</a>
														${modMixLR.mMixLRContentTwo}
													</p>
													<p>
														<a href="#" class="pic_con_style_tu21"> 
															<img src="${ctx1}/newsImgUp/${modMixLR.mMixLRImgThree}" align="right" width="310px" height="130.px"/>
														</a>
														${modMixLR.mMixLRContentThree}
													</p>
													</c:forEach>
												</c:if>
												</div>
