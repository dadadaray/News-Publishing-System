                                        ...
                                        <form class="am-form tpl-form-line-form">
                                            ...
                                            <div>  
                                                ...
                                                <div style="padding:10px;align:center;">
                                                    <textarea rows="8" style="width:80%;font-size:16px; line-height: 28px;border:1px solid #c2cad8;margin:0 auto;" maxlength="200" placeholder="请输入不超过200字内容"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="am-u-sm-8 am-u-sm-push-2 add_button">
                                                ...
                                                <a href="../前台/news_post_style3_eye.html" class="am-btn am-btn-primary tpl-btn-bg-color-success add_eye">预  览</a>
