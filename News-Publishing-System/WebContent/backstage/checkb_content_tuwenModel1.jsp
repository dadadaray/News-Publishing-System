									...
									<div class="general_content">
										<div class="main_content" id="con_eye">
											...
											<article class="block_single_news">
												...
												<div class="content">
												<c:if test="${not empty OneNews.modMixCenters}">
                               						<c:forEach items="${OneNews.modMixCenters}" var="modMixCenter">		
                               																
													<div class="pic_con_sty1">
														<img class="pic_con_style_tu" width="620px" height="260.px"
															src="${ctx1}/newsImgUp/${modMixCenter.mMixCenterImgOne}" alt="" />
													</div>
													<p class="text_p">
													...
													<div class="pic_con_sty1">
														<img class="pic_con_style_tu" width="620px" height="260.px"
															src="${ctx1}/newsImgUp/${modMixCenter.mMixCenterImgTwo}" alt="" />
													</div>

													<p class="text_p">
														${modMixCenter.mMixCenterContentTwo}
													</p>
													<div class="pic_con_sty1">
														<img class="pic_con_style_tu" width="620px" height="260.px"
															src="${ctx1}/newsImgUp/${modMixCenter.mMixCenterImgThree}" alt="" />
													</div>

													<p class="text_p">
														${modMixCenter.mMixCenterContentThree}
													</p>
