                    ...
                    <div class="tpl-portlet">
                        <div class="portlet-title">
                            <div class="caption font-green bold">
                                ...
                                <a href="${ctx}/add_news_tuwenModel.jsp"><span class="model_return">返&nbsp&nbsp回</span></a> 
                            </div>
                            <div class="tpl-block">
                                <div class="am-g">
                                        ...
                                        <form class="am-form tpl-form-line-form">
                                            ...
                                            <div>  
                                                <div style="padding:10px;text-align:center;">
                                                    <!--  图片上传显示-->
                                                    <!--input-group start-->
                                                    <div class="upload_box"><input type="file" name="file"  class="file" onchange="imgChange(this);" style="width:400px;margin:10px auto 0px 80px;" /><div class="preview"><img class="imghead" src="${ctx}/assets/img/add.png" width="610" height="260"/></div></div>
                                                    <!--input-group end-->                                                 
                                                </div>
                                                ...
                                                <div style="padding:10px;text-align:center;">
                                                    <!--  图片上传显示-->
                                                    <!--input-group start-->
                                                    <div class="upload_box"><input type="file" name="file"  class="file" onchange="imgChange(this);" style="width:400px;margin:10px auto 0px 80px; outline: none;" /><div class="preview"><img class="imghead" src="${ctx}/assets/img/add.png" width="610" height="260"/></div></div>
                                                    <!--input-group end-->  
                                                </div>
                                                <div style="padding:10px;align:center;">
                                                    <textarea rows="8" style="width:80%;font-size:16px; line-height: 28px;border:1px solid #c2cad8;margin:0 auto;" maxlength="200" placeholder="请输入不超过200字内容" required></textarea>
                                            ...
                                            <div class="am-form-group">
                                                ...
                                                <div class="am-u-sm-10">
                                                    <!--  图片上传显示-->
                                                    <!--input-group start-->
                                                    <div class="upload_box"><input type="file" name="file"  class="file" onchange="imgChange(this);" style="width:260px" /><div class="preview" style="margin-top: 20px; outline: none;"><img class="imghead" src="${ctx}/assets/img/add.png" width="320" height="136"/></div></div>
                                                    <!--input-group end-->
                                                </div>
                                            </div> 
