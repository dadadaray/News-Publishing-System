                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display:block">
                            <li>
                                ...
                                <a href="all_news_checked.html" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span>未通过类表</span>
                                </a>
                            </li>
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-file-text-o"> </span>  未通过列表
                    </div>
                            ...
                            <div class="am-u-sm-12 am-u-md-9">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a href="add_news.html" class="am-btn am-btn-default am-btn-secondary"><span class="am-icon-plus"></span> 新增文章</a>
                                        <button type="button" class="am-btn am-btn-default am-btn-danger"><span class="am-icon-trash-o"></span> 删除文章</button>
                                    </div>
                                </div>
                            </div>
