          ...
          <ul class="tpl-left-nav-menu">
           ...
           <li class="tpl-left-nav-item">
            ...
            <ul class="tpl-left-nav-sub-menu" style="display:block;">
              <li>
                  <a href="${ctx1}/backstage/news/back/checking/list" class="active">
                    ...
                    <div class="tpl-block">
                      <div class="am-g">
                        ...
                        <article class="block_single_news">
                            ...
                            <div class="info row">
                                <div class="am-u-md-4 am-u-sm-4 date"><p><fmt:formatDate value="${OneNews.createTime}" pattern="yyyy-MM-dd" /></p></div>
                                <div class="am-u-md-4 am-u-sm-4 author"><p>作者: <a href="#">${OneNews.userInfo.loginUser.loginName}</a></p></div>
                            ...
                            <div class="content">
								<div class="f_pic" style="text-align:center;">
									<a href="#">
		                                <c:if test="${not empty OneNews.modMixSingles}">
		                               		<c:forEach items="${OneNews.modMixSingles}" var="modMixSingle">
		                               				<img src="${ctx1}/newsImgUp/${modMixSingle.mMixSingleImgOne}" alt="" width="620px" height="260.px"/>
		                               		</c:forEach>
		                               	</c:if>									
									</a>
								</div>
