											...
											<article class="block_single_news">
												...
												<c:if test="${not empty OneNews.modVedios}">
						                            ...
						                            <div class="block_video">
						                              	<video width="612" height="344px" poster="${ctx1}/newsVideoUp/${modVedio.mVideoCoverImgUrl}" controls="controls">
															<source src="${ctx1}/newsVideoUp/${modVedio.mvideoUrl}" type="video/ogg">
															<source src="${ctx1}/newsVideoUp/${modVedio.mvideoUrl}" type="video/mp4">
															<source src="${ctx1}/newsVideoUp/${modVedio.mvideoUrl}" type="video/webm">
															<object data="${ctx1}/newsVideoUp/${modVedio.mvideoUrl}" width="612" height="344"> </object>
														</video>
						                            </div>
													<p class="text_p">
