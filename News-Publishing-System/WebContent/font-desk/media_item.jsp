                    	...
                    	<nav class="main_menu">
                        	<ul>
								<li><a href="index.html">Home</a>
					  	  		...
					  	  		<li class="current_page_item"><a href="media.html">Media</a>
                        ...
                        <article class="block_media_item">
                        	<div class="f_item">
                            	<div id="media_item_slider" class="media_item_slider flexslider">
                                	<ul class="slides">
                                    	<li>
                                        	<img src="images/pic_media_item_1.jpg" alt="" />
                                        ...
                                        <li>
                                        	<img src="images/pic_media_item_3.jpg" alt="" />
                                ...
                                <div id="media_item_navigation" class="media_item_navigation flexslider">
                                	<ul class="slides">
                                    	<li><img src="images/pic_media_item_1_sm.jpg" alt="" /><span class="current"></span></li>
                                        <li><img src="images/pic_media_item_2_sm.jpg" alt="" /><span class="current"></span></li>
                                        <li><img src="images/pic_media_item_3_sm.jpg" alt="" /><span class="current"></span></li>
                                        <li><img src="images/pic_media_item_4_sm.jpg" alt="" /><span class="current"></span></li>
                                        <li><img src="images/pic_media_item_5_sm.jpg" alt="" /><span class="current"></span></li>
                                        <li><img src="images/pic_media_item_6_sm.jpg" alt="" /><span class="current"></span></li>
                                        <li><img src="images/pic_media_item_1_sm.jpg" alt="" /><span class="current"></span></li>
                                        <li><img src="images/pic_media_item_2_sm.jpg" alt="" /><span class="current"></span></li>
                                        <li><img src="images/pic_media_item_3_sm.jpg" alt="" /><span class="current"></span></li>
                                        <li><img src="images/pic_media_item_4_sm.jpg" alt="" /><span class="current"></span></li>
