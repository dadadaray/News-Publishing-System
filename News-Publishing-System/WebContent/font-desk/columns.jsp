...
<head>
<title>BusinessNews - Shortcodes - Columns</title>
        	...
        	<div class="inner">
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <div class="line_4" style="margin:0px 0px 17px;"></div>
                        
                        <div class="one_half">
                        	<div class="dropcaps_5">1</div>
                            <p>There are many variations of passages of available, but the majority have suffered alteration.By randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                        </div>
                        
                        <div class="one_half last">
                        	<div class="dropcaps_5">2</div>
                            <p>There are many variations of passages of available, but the majority have suffered alteration.By randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                        </div>
                        
                        <div class="clearboth"></div>
                        
                        <div class="line_3" style="margin:3px 0px 17px;"></div>
                        
                        <div class="one_third">
                        	<div class="dropcaps_5">1</div>
                            <p>There are many variations of passages of available, but randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything.</p>
                        </div>
                        ...
                        <div class="one_third">
                        	<div class="dropcaps_5">1</div>
                            <p>There are many variations of passages of available, but randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there.</p>
                        </div>
                        
                        <div class="two_third last">
                        	<div class="dropcaps_5">2</div>
                            <p>There are many variations of passages of available, but the majority have suffered alteration.By injected humour, or randomised words randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything. established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                        </div>
                        ...
                        <div class="full_width">
                        	<div class="dropcaps_5">1</div>
                            <p>There are many variations of passages of available, but the majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything.established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                        </div>
