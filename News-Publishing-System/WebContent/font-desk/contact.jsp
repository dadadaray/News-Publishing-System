...
<head>
<title>BusinessNews - Contact</title>
        	...
        	<div class="inner">
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <p class="general_subtitle">Fact that a reader will be distracted by the readable content of a page when looking at its layout are many variations of passages have suffered alteration. Established fact that a reader will be distracted by the readable content.</p>
                        ...
                        <div class="block_contact_form">
                        	<form id="contact_form" action="php/contact_form.php" />
                                ...
                                <input type="submit" class="general_button" value="Send message" />
                            </form>
							<script type="text/javascript">
								$(function () {
                    ...
                    <div class="sidebar">
                        ...
                        <div class="block_contacts">
                            ...
                            <p class="address">265 Your Street Name, Paris, CA 15789, France</p>
                            <p class="phone">Phone: (800) 241-1478</p>
                            <p class="email">E-mail: <a href="mailto:#" target="_blank">contact@businessnews.com</a></p>
                            <p class="web">Web: <a href="#">www.businessnews.com</a></p>
                        </div>
                    </div>
