...
<head>
<title>BusinessNews - Shortcodes - Tabs</title>
                    	...
                    	<nav class="main_menu">
                        	<ul>
								<li><a href="index.html">Home</a>
				  		  		...
				  		  		<li class="current_page_item"><a href="typography.html">Shortcodes</a>
            	...
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <div class="block_tabs_type_1">
                            <div class="tabs">
                                <ul>
                                    <li><a href="#1" class="current">First Tab</a></li><!-- tab link -->
                                    <li><a href="#2">Second Tab</a></li><!-- tab link -->
                                    <li><a href="#3">Third Tab</a></li><!-- tab link -->
                                </ul>
                            </div>
                                        
                            <div class="tab_content">
                                <!-- tab content goes here -->
                                <p>Randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be istracted by the readable content of a page when looking at its layout. </p>
                            </div>
                                        
                      		<div class="tab_content">
                                <!-- tab content goes here -->
                                <p>Randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be istracted by the readable content of a page when looking at its layout. Randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be istracted by the readable content of a page when looking at its layout.</p>
                            </div>
                                        
                      		<div class="tab_content">
                                <!-- tab content goes here -->
                                <p>Randomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be istracted by the readable content.</p>
                            </div>
                        ...
                        <div class="block_tabs_type_2">
                            <div class="tabs">
                                <ul>
                                    <li><a href="#1" class="current">Readable content</a></li><!-- tab link -->
                                    <li><a href="#2">Many variations</a></li><!-- tab link -->
                                    <li><a href="#3">Randomised words</a></li><!-- tab link -->
                                </ul>
                            </div>
                                        
                            <div class="tab_content">
                                <!-- tab content goes here -->
                                <p>Slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be istracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letter. Established fact that a reader will be istracted by the readable content.</p>
                            </div>
                                        
                            <div class="tab_content">
                                <!-- tab content goes here -->
                                <p>Slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be istracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letter. Established fact that a reader will be istracted by the readable content. Slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be istracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letter. Established fact that a reader will be istracted by the readable content.</p>
                            </div>
                                        
                            <div class="tab_content">
                                <!-- tab content goes here -->
                                <p>Slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be istracted by the readable content of a page when looking at its layout.</p>
                            </div>
