...
<head>
<title>BusinessNews - Shortcodes - Block Quote</title>
        	...
        	<div class="inner">
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <p>There are many variations of passages of available, but the majority have suffered alteration. By injected humour, or randomised <abbr class="the_abbr" title="">words which don't look</abbr> even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                        ...
                        <blockquote class="left">Need to be sure there isn't anything embarrassing hidden in the middle of text. established.</blockquote>
                        
                        <p>Majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't <ins class="the_ins_1" cite="cite_text" datetime="datetime_text">anything embarrassing</ins> available, but the majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. Established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less.</p>
                        
                        <blockquote class="right">Sure there isn't anything embarrassing hidden in the middle of text. established.</blockquote>
                        
                        <p>Majority have suffered alteration.By injected humour, or words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't but the <ins class="the_ins_2" cite="cite_text" datetime="datetime_text">majority have suffered</ins> alteration.By injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. Established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
