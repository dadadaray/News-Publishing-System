...
<head>
<title>BusinessNews - Typography</title>
        	...
        	<div class="inner">
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <h1 style="padding-bottom:11px;">This is the First Heading â H1</h1>
                        <p>Many variations of passages of available, but the majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable.</p>
                        <div class="line_3" style="margin:0px 0px 16px;"></div>
                        
                        <h2 style="padding-bottom:12px;">This is the Second Heading â H2</h2>
                        <p>Many variations of passages of available, but the majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable.</p>
                        <div class="line_3" style="margin:0px 0px 17px;"></div>
                        
                        <h3 style="padding-bottom:12px;">This is the Third Heading â H3</h3>
                        <p>Many variations of passages of available, but the majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable.</p>
                        <div class="line_3" style="margin:0px 0px 17px;"></div>
                        
                        <h4 style="padding-bottom:12px;">This is the Forth Heading â H4</h4>
                        <p>Many variations of passages of available, but the majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable.</p>
                        <div class="line_3" style="margin:0px 0px 17px;"></div>
                        
                        <h5 style="padding-bottom:13px;">This is the Fifth Heading â H5</h5>
                        <p>Many variations of passages of available, but the majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable.</p>
                        <div class="line_3" style="margin:0px 0px 17px;"></div>
                        
                        <h6>This is the Sixth Heading â H6</h6>
                        <p>Many variations of passages of available, but the majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable.</p>
                        <div class="line_2" style="margin:4px 0px 31px;"></div>
                        
                        <h3 style="padding-bottom:17px;">Highlights</h3>
                        <p>There are many variations of passages of <ins class="the_ins_1" cite="cite_text" datetime="datetime_text">this is a highlight red</ins> have suffered alteration.By injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be <ins class="the_ins_3" cite="cite_text" datetime="datetime_text">this is a highlight black</ins> embarrassing hidden in the middle of text.</p>
                        <div class="line_2" style="margin:4px 0px 31px;"></div>
                        
                        <h3 style="padding-bottom:17px;">Unordered list</h3>
                        <ul class="list">
                        	<li>Passages of this is a highlight red have suffered alteration.By injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be this is a highlight black embarrassing hidden.</li>
                            <li>Highlight red have suffered alteration.By injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage need to be this is a highlight black.</li>
                            <li>Red have suffered alteration.By injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be this is a highlight black embarrassing hidden. Injected humour, or randomised words which.</li>
                        </ul>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even.</p>
                        <div class="line_3" style="margin:1px 0px 15px;"></div>
                        ...
                        <div class="line_2" style="margin:0px 0px 31px;"></div>
                        
                        <h3 style="padding-bottom:17px;">Paraghraph With Image</h3>
                        <a href="#" class="pic w_frame alignleft"><img src="images/pic_typography_1.jpg" alt="" /></a>
                        <p>There are many variations of passages of available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum Dolore Ibanez, you need to be sure there isn't anything embarrassing.</p>
                        <p>Hidden in the middle of text. All the generators on the Internet tend to Available, but the majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of you need to be sure there isn't anything.</p>
                        
                        <a href="#" class="pic w_frame alignright"><img src="images/pic_typography_2.jpg" alt="" /></a>
                        <p>Variations of passages of available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything.</p>
                        <p>All the generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet uses a</p>
                        <p>but the majority have suffered alteration.By injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything.</p>
                        <div class="line_2" style="margin:4px 0px 31px;"></div>
                        
                        <h3 style="padding-bottom:15px;">Example of Dropcaps</h3>
                        <div class="dropcaps_1">R</div>
                        ...
                        <div class="line_3" style="margin:-3px 0px 10px;"></div>
                        
                        <div class="dropcaps_2">R</div>
                        <p>andomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of textreadable content of a page.</p>
                        <div class="line_2" style="margin:4px 0px 0px;"></div>
