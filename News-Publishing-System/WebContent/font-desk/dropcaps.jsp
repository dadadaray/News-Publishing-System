...
<head>
<title>BusinessNews - Shortcodes - Dropcaps</title>
        	...
        	<div class="inner">
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <h5 style="padding-bottom:11px;">Style 1</h5>
                        ...
                        <h5 style="padding-bottom:11px;">Style 2</h5>
                        <div class="dropcaps_2">R</div>
                        <p>andomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of textreadable content of a page.</p>
                        
                        <div class="line_2" style="margin:3px 0px 20px;"></div>
                        
                        <h5 style="padding-bottom:11px;">Style 3</h5>
                        <div class="dropcaps_3">R</div>
                        <p>andomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of textreadable content of a page.</p>
                        
                        <div class="line_2" style="margin:3px 0px 20px;"></div>
                        
                        <h5 style="padding-bottom:11px;">Style 4</h5>
                        <div class="dropcaps_4">R</div>
                        <p>andomised words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of text established fact that a reader will be words which don't look even slightly believable. If you are going to use a passage. You need to be sure there isn't anything embarrassing hidden in the middle of textreadable content of a page.</p>
