ffr7555<%@ page language="java" contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" import="java.util.Date"%>
					...
					<div class="main_content">
						...
						<article class="block_single_news">
							...
							<div class="info">
								<div class="date">
									<p>
										<fmt:formatDate value="${mod1viewcurrentTime}" pattern="yyyy-MM-dd HH:mm:ss" />
										<a href="#">${OneNews.userInfo.loginUser.loginName}</a>
									</p>
								</div>
