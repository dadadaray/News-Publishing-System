				...
				<div class="general_content">
					<div class="main_content">
						...
						<article class="block_single_news">
							...
							<div class="info">
								<div class="date">
									<p><fmt:formatDate value="${OneNews.publishTime}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
								</div>
								<div class="author">
									<p>
							...
							<div class="content">
							<c:forEach items="${OneNews.modFrees}" var="mods" varStatus="status">
								<p class="text_p">
									${mods.modFreeContent}<a href="#" class="lnk_blue text_a"></a>
								</p>
							</c:forEach>
							</div>
						</article>
